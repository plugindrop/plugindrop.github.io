...
|--------|-------|----------|--------|
| Serum | $189 | Wavetable synthesis, leads, basses | [Get Serum](https://xferrecords.com/products/serum) |
...
|--------|-------|------|------------|-----|
| Serum | $189 | Wavetable synth | Industry standard, deep preset ecosystem | [Get](https://xferrecords.com/products/serum) |
...
[→ Start with Serum](https://xferrecords.com/products/serum)
